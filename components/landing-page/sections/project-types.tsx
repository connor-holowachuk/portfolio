...
const ProjectTypeCard = ({
	...
	return (
		<div className="cursor-pointer flex flex-col group h-full hover:bg-primary text-white hover:text-background transition-all  ease-in-outtransition-all duration-200 ease-in-out relative">
